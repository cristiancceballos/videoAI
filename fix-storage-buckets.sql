-- Fix Storage Buckets and Policies for Thumbnail Upload
-- This script ensures buckets exist and service role can upload thumbnails
...
-- 2. Enable RLS on storage tables
ALTER TABLE storage.buckets ENABLE ROW LEVEL SECURITY;
ALTER TABLE storage.objects ENABLE ROW LEVEL SECURITY;

-- 3. Drop any conflicting policies first (in case they exist without IF NOT EXISTS)
...
-- This is what was missing - Edge Functions use service_role authentication
...
-- 9. Test service role access (this should return true)
SELECT 'Service Role Test:' as status;
